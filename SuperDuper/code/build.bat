...
REM SET CompilerFlags=/nologo /Z7 /Od /Oi /MTd /fp:fast /FC /WX /W4 /wd4201 /wd4100 /wd4189 /wd4456 /wd4505 /wd4324 /DSUPER_INTERNAL=1
SET LinkerFlags=/incremental:no /opt:ref user32.lib Comctl32.lib gdi32.lib shell32.lib Comdlg32.lib

SET CompilerFlags=/nologo /Z7 /O2 /Oi /MT /fp:fast /FC /WX /W4 /wd4201 /wd4100 /wd4189 /wd4456 /wd4505 /wd4324
